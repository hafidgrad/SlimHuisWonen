    ...
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <article className="prose prose-zinc max-w-none">
        ...
        <ol>
          ...
          <li>
            Je netwerknaam (SSID) bevat rare tekens/emoji/symbolen.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>Zet beveiliging op <strong>WPA2</strong> of <strong>WPA2/WPA3 mixed</strong>.</li>
          <li>
            Gebruik een simpele SSID (alleen letters/cijfers, geen speciale tekens).
          </li>
          <li>Zet “AP/client isolation” <strong>uit</strong>.</li>
          <li>Herstart router + apparaat en probeer opnieuw.</li>
        </ul>

        <p>
          Tip: als het apparaat een reset-knop heeft, doe een volledige reset
          voordat je opnieuw koppelt. Veel apparaten “onthouden” een mislukte poging.
        </p>
      </article>
    </main>
  );

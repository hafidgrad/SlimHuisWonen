export const aanraders = [
    ...
    picks: [
      {
        ...
        description:
          "Hoge beeldkwaliteit, stabiele verbinding en geen gedoe met opladen.",
...

  {
    ...
    description:
      "Op zoek naar de beste slimme verlichting? Bekijk onze aanraders voor Philips Hue, Innr, Tapo en Govee.",
    ...
    picks: [
      {
        ...
        description:
          "De meest stabiele slimme verlichting met het beste ecosysteem.",
      ...
      },
      {
        ...
        description:
          "Goede Zigbee-verlichting zonder de hoge prijs van Hue.",
    ...
    picks: [
      {
        ...
        description:
          "Gebruiksvriendelijk, veel integraties (Zigbee, Z-Wave, Matter, Wi-Fi) en krachtige automatiseringen.",
      ...
      },
      {
        ...
        description:
          "Maximale controle, volledig lokaal en eindeloos uitbreidbaar.",
      ...
      },
      {
        ...
        description:
          "Ideaal als je al veel Samsung-apparaten gebruikt via SmartThings.",
